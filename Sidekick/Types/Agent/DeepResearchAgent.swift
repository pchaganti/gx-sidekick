...
Respond with YES if ALL 3 criteria above have been met. Alternatively, if you have already asked a set of follow up questions, respond with YES. Else, respond with NO.
